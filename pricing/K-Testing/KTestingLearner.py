...
class KTestingLearner:
    ...
    def __init__(self, environment, num_of_candidates, marginal_profits, tot_samples, alpha=0.05):
    ...
    def __select_winner(self):
        ...
        self.empirical_means = (self.empirical_means - np.amin(self.empirical_means)) / (
        ...
        best_empirical = self.empirical_means.argmax()
...
if __name__ == '__main__':
    ...
    for experiment in range(1000):
        learner = KTestingLearner(num_of_candidates=4, marginal_profits=MP, tot_samples=1000,
