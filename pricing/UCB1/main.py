...
probabilities2 = [[0.15, 0.1, 0.2, 0.35], [0.35, 0.21, 0.2, 0.35], [0.5, 0.1, 0.1, 0.15], [0.5, 0.1, 0.1, 0.15], [0.8, 0.21, 0.1, 0.15]]
timeHorizon = 400
...
# mpl.plot(np.cumsum(np.mean(np.array(env2.clairvoyant_arm - np.array(rewards_perExp2)), axis=0)))
